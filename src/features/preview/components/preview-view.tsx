...
import { PreviewSettingsPopover } from "@/features/preview/components/previewsettingsPopover";
import { PerviewTerminal } from "@/features/preview/components/preview-terminal";
import { Button } from "@/components/ui/button";
import { useProject } from "@/features/projects/components/hooks/use-projects";
...
export const PreviewView = ({ projectId }: { projectId: Id<"projects"> }) => {
    ...
    const {
        status, previewUrl, error, restart, terminalOuput
    } = useWebcontainer({
        projectId,
        enabled: true,
        ...
        <div className="h-full flex flex-col bg-background">
            ...
            <div className="flex-1 min-h-0">
                <Allotment vertical>
                    <Allotment.Pane>
                        {error && (
                            <div className="size-full flex itmes-center justify-center text-muted-foreground">
                        ...
                        {isLoading && !error && (
                            <div className="size-full flex itmes-center justify-center text-muted-foreground">
                                <div className="flex flex-col itmes-center gap-2 max-v-md mx-auto text-center">
                    ...
                    {showTerminal && (
                        <Allotment.Pane minSize={100} maxSize={500} preferredSize={200}>
                            <div className="h-full flex flex-col bg-background border-t">
                                ...
                                <PerviewTerminal output={terminalOuput} />
                            </div>
                        </Allotment.Pane>
                    )}
                </Allotment>
